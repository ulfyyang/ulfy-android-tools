...
class PathConfig:
    ...
    init_arrow = init_drawable_path + '/white_back_arrow.png'
    ...
    runtime_layout_normal = runtime_template_path + '/layout_normal.xml'
    runtime_selector = runtime_template_path + '/selector.xml'
    runtime_shape_circle = runtime_template_path + '/shape_circle.xml'
    runtime_shape_rectangle = runtime_template_path + '/shape_rectangle.xml'
